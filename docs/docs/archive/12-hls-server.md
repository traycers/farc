...
**Ответственность:** держит набор обслуживаемых каналов в актуальном состоянии относительно живого списка каналов на `farcd` (ADR-021) — без перезапуска процесса `hls_server`.
