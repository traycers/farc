...
**Устройство одного фблока.** Заголовок и индексы лежат не отдельно от массива и не в каком-то одном выделенном фблоке — у **каждого** фблока, включая Фблок 0 и Фблок N-1, одинаковый внутренний состав: собственный заголовок с индексами (ADR-001, ADR-002) и данные, разбитые на фчанки.

```mermaid
graph TD
    F["Фблок k<br/>(любой, k = 0..N-1 — устройство одинаковое)"]
    F --> H["Заголовок + индексы<br/>(снимок состояний всех фблоков Storage)"]
    F --> C0["Фчанк 0"]
    F --> C1["Фчанк 1"]
    F --> CM["Фчанк M-1"]
```

Полная бинарная раскладка секций внутри фблока (пролог, каталог, контрольные суммы, контент, TOC, эпилог) — `03-storage-format.md` §3.2; здесь — только то, что нужно для дальнейшего изложения этого документа: заголовок+индексы и данные-в-фчанках у каждого фблока свои.
